                ...
                <div id="show-enrollment" class="col-12 content scaffold-show" role="main">
                    ...
                    <g:form resource="${this.enrollment}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link resource="${this.enrollment}" action="reject" class="btn btn-danger">Reject</g:link>
                            <g:link resource="${this.enrollment}" action="approve" class="btn btn-success">Approve</g:link>
                            <g:link class="edit" action="edit" resource="${this.enrollment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
